...
public interface AgendamentoRepository extends JpaRepository<Agendamento, Long> {
    ...
    List<Agendamento> findByDataBetweenOrderByDataAscHoraAsc(LocalDate dataInicio, LocalDate dataFim);

    boolean existsByDataAndHoraAndStatus(LocalDate data, LocalTime hora, StatusAgendamento status);
}